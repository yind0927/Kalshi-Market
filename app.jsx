    ...
    <div className="card ens-card">
      <div className="card-head">
        <div>
          ...
          <div className="sub">NWS官方 + Open-Meteo · GFS / HRRR / ICON / NAM · 日内最高温 08:00–22:00 本地时</div>
        </div>
      ...
      {dist && (
        <div className="ens-note">
          加权均值 {dist.mean}°F → 修正后 {dist.adjustedMean}°F（NWS×0.30 · HRRR×0.25 · ICON×0.20 · GFS×0.15 · NAM×0.10，共 {dist.modelCount}/5 模型）· 区间 {dist.modelMin}–{dist.modelMax}°F · σ {dist.adjustedStd}°F
        </div>
      )}
  ...
  return (
    <div className="card">
      ...
      <div className="kv-list">
        ...
        <div className="row"><span className="k">Models</span><span className="v">NWS · GFS · HRRR · ICON · NAM</span></div>
...
function SettingsDrawer({ open, onClose, theme, setTheme, refreshCadence, setRefreshCadence }) {
  const [s, setS] = useState({
    ...
    models: { GFS: true, NWS: true, HRRR: true, ICON: true, NAM: true, HWRF: false },
        ...
        <div className="settings-body">
          ...
          <div className="settings-section">
            ...
            <SettingsRowStack label="Active ensembles" cn="集成模型"
              desc="选择参与概率融合的天气模型">
              <PillToggle options={["GFS", "NWS", "HRRR", "ICON", "NAM"]} value={s.models}
