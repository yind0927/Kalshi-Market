...
window.KW_WC_DATA = (function () {
  ...
  const GROUPS = {
    ...
    K: {
      ...
      matches:[
        { id:"WC2026-POR-COD", round:1, homeCode:"POR", awayCode:"COD",
          ...
          result: fin(1,1) },
        m("WC2026-COL-UZB",1,"COL","UZB","2026-06-18T02:00:00Z","6/18 10:00","Estadio Azteca · Mexico City",              fin(2,1)),
    ...
    L: {
      ...
      matches:[
        m("WC2026-ENG-CRO",1,"ENG","CRO","2026-06-17T20:00:00Z","6/18 04:00","AT&T Stadium · Arlington, TX",             fin(4,2)),
        m("WC2026-GHA-PAN",1,"GHA","PAN","2026-06-17T23:00:00Z","6/18 07:00","BMO Field · Toronto, ON",                  fin(1,0)),
